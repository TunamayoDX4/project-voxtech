use wgpu::{
  util::DeviceExt, Buffer, PipelineLayout, RenderPipeline,
};
...
impl WorldRenderer {
  pub fn new(
    ...
    let camera = super::camera::CameraUniformInstance::new(
      context, camera,
    );
    let pipeline_layout = context
      ...
      .create_pipeline_layout(
        &wgpu::PipelineLayoutDescriptor {
          ...
          bind_group_layouts: &[&camera.bindgroup_layout],
    ...
    let indices = context
      ...
      .create_buffer_init(
        &wgpu::util::BufferInitDescriptor {
          ...
          contents: bytemuck::cast_slice(types::TILE_INDICES),
  ...
  pub fn rendering(
      ...
      );
    {
      ...
      for i in 0..self.vertices.len() {
        render_pass
          .set_vertex_buffer(0, self.vertices[i].slice(..));
